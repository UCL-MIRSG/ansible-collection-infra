...
Ansible collections and roles, choosing the requirements file appropriate for
your environment (e.g., [EL7](meta/el7-requirements.yml) or
[EL9](meta/el9-requirements.yml)).
